...
export function Experience() {
  ...
  return (
    <section id="experience" className="py-16 sm:py-20 md:py-24 lg:py-32 bg-transparent relative">
            ...
            {experience.map((exp, idx) => (
              ...
              >
                ...
                <div className="md:grid md:grid-cols-[120px_1fr] md:gap-8 items-start md:pl-0">
                  ...
                  <div className={`${glassClasses} rounded-2xl`}>
                    <div className={cardHoverOverlay} aria-hidden="true" />

                    <div className="relative z-10">
                      <span className="md:hidden text-sm font-bold text-primary bg-primary/10 px-4 py-1.5 rounded-full border border-primary/20 inline-block shadow-sm mb-3">
                        {exp.period}
                      </span>
